...
. On the *Transit Gateways* page, in the *VPCs* section, click the *X* icon in the appropriate TGW route row of the route table:
+
_update screenshot - content and styles changed_
+
...
You might need to remove a transit gateway if you've reached your entitlement limit or you want to switch to a new transit gateway.
