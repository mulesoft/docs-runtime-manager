...
In this scenario, you are using a 1:1 relationship, which means that each Anypoint VPC can connect to a single public IP address at a remote location. One license is used per remote location.
