...
When you are planning and configuring your CloudHub VPCs, you should make sure you have enough licenses to meet your requirements. 
...
=== Connect Two VPCs to Two Remote Locations Each

If you implement a VPC deployment scenario where both VPCs connect to two remote locations, four VPC licenses are required, even if you are using the same two public IP addresses. This is because each remote location that needs to be accessible from the CloudHub VPC requires an additional VPC license.
