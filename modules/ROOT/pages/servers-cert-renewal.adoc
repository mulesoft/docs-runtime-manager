...
To renew a certificate for servers ins a cluster or group:
...
If, after following the steps previously described, the *Renew Certificate* option in the *Actions* pull-down menu is not available, you might need to xref:installing-and-configuring-runtime-manager-agent#update-the-agent.adoc[update your *Agent* version].
...
You can hover over the *Renew Certificate* option in the *Actions* pull-don menu, and a tooltip in the UI will tell you the minimum required Runtime Agent version.
