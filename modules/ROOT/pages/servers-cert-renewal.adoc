...
If, after following the steps previously described, the *Renew Certificate* option in the *Actions* pull-don menu is not available, you might need to xref:installing-and-configuring-runtime-manager-agent#update-the-agent.adoc[update your *Agent* version].
