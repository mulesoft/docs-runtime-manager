...
If you click *Start* or *Stop* for a flow in the *Flow Management* tab, Runtime Manager continually enforces the active or inactive state onto the flow, regardless of any changes that the Mule runtime may attempt.
