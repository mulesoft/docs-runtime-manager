...
* NodeJS, and NPM (Node's package manager) installed in your machine. +
Go to the https://nodejs.org/en/download/[NodeJS download page] to get both resources.
* Git version management system on your computer. +
Go to the https://git-scm.com/downloads[Git Download site] to get this resource.
