...
This service allows you to provide custom certificates and optionally enforce two-way SSL client authentication. You can configure proxy rules that map your applications to custom domains, which enables you to for example host everything under a single vanity domain.
