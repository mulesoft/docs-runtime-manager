...
Four firewall rules are created by default--two rules allowing your private address space through ports 8091 and 8092, and two rules that whitelist external requests proxied by CloudHub's shared load balancer through ports 8081 and 8082. +
