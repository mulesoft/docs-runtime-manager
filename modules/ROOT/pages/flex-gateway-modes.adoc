...
With Connected Mode, you can configure Anypoint Flex Gateway to surface your gateways in Runtime Manager, and their APIs and policy configurations in API Manager.
