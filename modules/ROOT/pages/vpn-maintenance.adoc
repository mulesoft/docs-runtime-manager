...
Mule applications that use Anypoint VPN connectivity are impacted during the on-demand maintenance. The impact on the Anypoint VPN varies depending on the VPN configuration:
