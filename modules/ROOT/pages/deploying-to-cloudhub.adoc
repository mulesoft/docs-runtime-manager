...
[TIP]
With the CloudHub dedicated load balancer, you can then optionally implement xref:runtime-manager/lb-mapping-rules[mapping rules] to set your application's public URL to any other path you choose, as long as you own the domain.
...
For more information about deploying to on-premises servers, server groups, and clusters, see xref:deploying-to-your-own-servers.adoc[Deploying to Your Servers].


== Deploy an Application to CloudHub from Studio

You can deploy your applications to CloudHub from Studio.
...
+
You can manage these credentials from the *Anypoint Studio* > *Preferences* menu, in *Anypoint Studio* > *Authentication*.
