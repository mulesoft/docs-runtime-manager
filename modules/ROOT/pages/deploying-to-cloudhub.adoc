...
If your application requires more storage (for example, verbose logging), use a worker with two or more vCores, enabling the application to access the additional storage in `/tmp`.
...
. In the *Applications* tab, select the application name.
