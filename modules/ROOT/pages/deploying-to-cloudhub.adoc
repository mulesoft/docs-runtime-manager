...
* Studio: right-click your project and click *Deploy to Anypoint Platform*, then *Cloud*.
* Runtime Manager: in the cloud-based version of https://anypoint.mulesoft.com[Anypoint Platform]. Go to the *Runtime Manager* section, then from the *Applications* tab, click *Deploy application*.
...
For an example of deploying to CloudHub directly from Studio, see xref:general:runtime-manager:deploying-to-cloudhub.adoc[Deploying to CloudHub].

=== Deploy from Runtime Manager

. Sign on to https://anypoint.mulesoft.com[Anypoint Platform] or click *Sign up* on the sign on page.
...
. If you do not already have access to the Anypoint-CLI command line tool, install it using xref:runtime-manager::anypoint-platform-cli.adoc#installation[Anypoint Platform CLI installation instructions].
...
. xref:runtime-manager::anypoint-platform-cli.adoc[Anypoint Platform CLI] contains a full list of commands.

=== Prepare to Deploy from a Sandbox
