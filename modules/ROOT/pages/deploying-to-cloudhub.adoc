...
* Select CloudHub as the *Deployment Target*
* Click *Choose File*, then select either:
** *Import file from Exchange*
** *Upload file*
. In the *Runtime* tab, select the values for: +
* *Runtime version*
* *Worker size*
* *Workers*
* *Region*
...
* *Automatically restart application when not responding* &#8211; Restart the application automatically when it is unresponsive.
* *Persistent queues* &#8211; Store data in an input queue to disk.
...
If you created an application in a sandbox environment and tested it, when you are ready to deploy the application, you must first move the application from the sandbox environment to the production environment.
