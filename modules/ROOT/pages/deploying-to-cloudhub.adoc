...
. In the *Deployment Target* menu, select *CloudHub*, if necessary.
...
+
See <<Move an Application from Sandbox to Production>>.
--
...
You can promote only applications deployed to CloudHub to run on other CloudHub workers.
