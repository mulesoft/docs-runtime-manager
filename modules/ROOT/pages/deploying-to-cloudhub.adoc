...
== Setup Deployment Failure Alert
It is highly recommended that you setup deployment failure alert to get notified by email when there is an error during deployment.

image::deployfailedalert.jpg[DeployAppFirstScreen]

[NOTE]

Be sure to fill in the form and choose "Deploymenbt failed" as alert condition.
