...
+
https://support.mulesoft.com/s/article/Connectivity-issues-between-Mule-Runtime-and-Anypoint-Runtime-manager-using-an-IBM-JVM[Connectivity issues between Mule Runtime and Anypoint Runtime Manager using an IBM JVM]
. Rename the file:
* `anypoint-truststore.jks` — Mule Runtime 4.1.3 (Mule Agent 2.1.4) and higher
* `truststore.jks` — Mule Runtime 4.1.2 (Mule Agent 2.1.3)
