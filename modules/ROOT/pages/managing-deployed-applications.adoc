...
The Application shows Started when it is running on any one of the Cluster nodes.
...
|===
|Icon|State|Description
|image:status-green.png[green]|Running|At least one of the Cluster nodes is running.
