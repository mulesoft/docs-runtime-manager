...
The states in this table need updating.
...
| image::managing-deployed-applications-ab70d.png[] | _status_? |Application update failed.
...
|Application deployment not complete.
