...
Replica statuses apply only to applications deployed on Runtime Fabric. These statuses appear when you are applying new, or changed, configurations to deployed applications. See xref:latest@runtime-fabric::app-versioning.adoc[Application Deployment Versioning] for more information.
...
To update applications deployed to Runtime Fabric, see xref:latest@runtime-fabric::app-versioning.adoc[Application Deployment Versioning]
...
* xref:latest@runtime-fabric::app-versioning.adoc[Application Deployment Versioning]
