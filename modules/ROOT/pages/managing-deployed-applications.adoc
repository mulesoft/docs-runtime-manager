...
Replica statuses apply only to applications deployed on Runtime Fabric. These statuses appear when you are applying new, or changed, configurations to deployed applications. See xref:app-versioning.adoc[Application Deployment Versioning] for more information.
...
* xref:app-versioning.adoc[Application Deployment Versioning]
