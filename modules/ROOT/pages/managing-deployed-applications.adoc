...
When you stop, restart, update, redeploy, or terminate an application, CloudHub tries to delete it from Mule with a timeout period of 2 minutes to wait for inflight messages to be delivered. After that period, CloudHub shuts down the whole instance.
