...
Remember that you must first <<Add a Server, register>> each of the servers to Runtime Manager, by downloading and installing the same version of the https://www.mulesoft.com/platform/mule[Mule runtime] and then running the xref:managing-servers.adoc#add-a-server[amc_setup] script on each.
