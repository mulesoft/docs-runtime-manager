...
* All DNS servers must present the same view of the DNS namespace. This means each server has valid and identical records for all of the private domains listed.
