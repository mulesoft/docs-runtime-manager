...
* All DNS servers must present the same view of the DNS namespace. Each server must have valid and identical records for all of the private domains listed.
