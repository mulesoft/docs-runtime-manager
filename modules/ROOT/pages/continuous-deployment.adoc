...
. Call *Login* on the Access Management API with valid Anypoint Platform user name and password to obtain the 'access_token' and 'token_type' to use in all the subsequent calls.
