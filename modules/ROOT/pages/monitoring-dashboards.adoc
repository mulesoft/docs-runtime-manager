...
Depending on the selected time range, the graphs show the average, minimum, and maximum:

[%header,cols="18,20,20,25"]
|===
| Selected Time Range | Number of Mule Messages | Number of Errors | Response Time (in milliseconds) 
| 3 Hours | Per minute | Per minute | Per minute
| 24 Hours | Per 8 minutes | Per 8 minutes | Per 8 minute
