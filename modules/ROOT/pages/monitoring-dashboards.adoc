...
This metric found in the *Overview* tab refers to the total heap memory usage in MB. See the <<Breakdown Tab,*Breakdown* tab>> for details about each of its component.
