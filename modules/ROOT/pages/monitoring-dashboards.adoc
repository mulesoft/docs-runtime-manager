...
Click the *Switch back to classic metrics* link view the classic application monitoring dashboard. Click the blue banner at the top of the page to switch back to the Anypoint Monitoring dashboard.
