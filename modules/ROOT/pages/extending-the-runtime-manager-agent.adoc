= Extending the Runtime Manager Agent for Hybrid
...
This topic contains an overview of how to extend the Anypoint Runtime Manager agent. It provides instructions on implementing a complete service, external handler and internal hander using a method to revert a string.
