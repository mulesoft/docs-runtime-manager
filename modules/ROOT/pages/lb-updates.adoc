...
The update prompts you to whitelist these new IP addresses before continuing with the update:

.The arrow shows the static IPs to whitelist in the *Update Load Balancer* window.
image::cloudhub-dlb-update-static-ips-whitelist.png[Static IPs to whitelist in the Update Load Balancer window.]

In this case, add the IP addresses to your whitelist before clicking *Update*.
