...
The *Update* button indicates a load balancer requires an update. You can schedule the update to occur at your convenience. It is recommended that you update the Sandbox DLB and run required tests before updating the Production DLB.
