...
* xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-load-balancer-create[cloudhub load-balancer create]
* xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-load-balancer-ssl-endpoint-add[cloudhub load-balancer ssl-endpoint add]
* xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-load-balancer-ssl-endpoint-set-default[cloudhub load-balancer ssl-endpoint set-default]
