...
Configuration steps differ based on the xref:virtual-private-cloud.adoc#vpc-connectivity-methods-concept[VPC connectivity methods] chosen. Follow these instructions to xref:virtual-private-cloud.adoc#to-request-vpc-connectivity[Request Anypoint VPC Connectivity to Your Network].
