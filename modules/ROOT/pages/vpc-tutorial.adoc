...
If you create an environment in Access Manager and attempt to immediately use it to create or edit a VPC in Runtime Manager, you may experience a delay to see the newly created environment in the VPCs *Environments* dropdown.
