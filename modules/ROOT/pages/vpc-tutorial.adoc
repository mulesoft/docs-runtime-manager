...
By default, all inbound traffic is open, and you need to configure firewall rules to block external traffic to your worker. You can configure these rules at a later time. +
