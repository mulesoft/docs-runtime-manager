...
Worker Memory is the maximum memory available for a worker while Heap Memory is the initial size allocated to the mule application running on that work.
