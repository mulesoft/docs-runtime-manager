...
This global distribution enables you to host your integration in a location that is closest to your services, thus reducing latency.
It can also enable adherence to local laws, such as the EU Data Protection Directive.
MuleSoft hosts the management console and platform services in the United States.
