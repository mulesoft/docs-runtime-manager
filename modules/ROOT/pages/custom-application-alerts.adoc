...
[source,xml,linenums]
----
<cloudhub:create-notification domain="osv2-demo2" doc:name="Create Notification" doc:id="doc-id" config-ref="CloudHub_Config" priority="INFO" transactionId="uuid()">
			<cloudhub:message ><![CDATA[#["Problem occurred trying to process customer data"]]]></cloudhub:message>
