...
Before going further, complete the xref:general:getting-started:deploy-to-cloudhub.adoc[Deploy to CloudHub] example as this builds on top of it. In addition, you need to have "Mavenized" your project within Studio. For more information, see xref:6@studio::enabling-maven-support-for-a-studio-project.adoc[Enabling Maven Support for a Studio Project].
