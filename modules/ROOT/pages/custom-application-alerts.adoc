...
Notifications give you the ability to give visibility into business related events inside your application. For example, you can create notifications for when:
...
Alerts allow you to send emails based on your application notifications. You can create alerts in CloudHub with the software provided. To create custom alerts, you need to get the https://www.mulesoft.com/exchange/#!/cloudhub-integration-connector[CloudHub Connector] and install it in Anypoint Studio.
