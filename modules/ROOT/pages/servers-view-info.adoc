...
.The lines show the *Applications* tab, servers list, and *Plugins* tab.
...
For clusters, the details pane displays the type (unicast or multicast).
...
.The lines show the *Heap Memory* graph, applications list, and *CPU* graph.
