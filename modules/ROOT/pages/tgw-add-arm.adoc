...
After the *VPC attached* message appears, you can add routes so apps deployed to the VPC can access the transit gateway and the transit gateway routes traffic correctly.
