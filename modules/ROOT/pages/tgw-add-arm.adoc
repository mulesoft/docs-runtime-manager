...
_Update screenshot missing space_
...
* On Anypoint Platform, <<enable_outbound_traffic_from_vpc,enable outbound traffic from the Anypoint VPC>> to an external destination.
