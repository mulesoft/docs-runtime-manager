...
.. Click the pencil icon and enter a name for the attachment. 
...
After the *VPC attached* message appears, add routes so apps deployed to the VPC 
...
For example, if you added xxx.xxx.xxx.xxx to the route table, 
