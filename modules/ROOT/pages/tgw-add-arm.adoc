...
. On AWS, on the *Create resource share* page:
+
--
...
+
.. Select the Transit Gateway attachment ID and, on the *Details* tab, ensure that the *Resource owner account ID* is the MuleSoft AWS account ID.
...
. On the *Add VPC Route* window, enter a single subnet in CIDR notation for your
AWS VPC:
+
