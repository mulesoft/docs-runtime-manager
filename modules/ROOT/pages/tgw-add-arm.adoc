...
.. Under *Principals - _optional_*, enter the MuleSoft AWS account ID (`008119339527`), and click *Add*.
...
+
image::tgw-resource-share-progress.png[Connect with AWS to add your transit gateway]
...
+
To verify that the attachment is correct, click the link in the *Transit Gateway ID* and ensure that the *Resource Owner Account ID* is the MuleSoft AWS account ID (`008119339527`)
