...
.. Under *Principals - _optional_*, ensure that *Allow external accounts* is selected, enter the MuleSoft AWS account ID (`494141260463`), and click *Add*.
+
...
+
To verify that the attachment is correct, select the Transit Gateway attachment ID and, in the *Details* tab, ensure that the *Resource owner account ID* is the MuleSoft AWS account ID (`494141260463`)
