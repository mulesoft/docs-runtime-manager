...
If you manually deploy applications on your on-premise servers, you can't see or manage them in Runtime Manager because the applications are not auto-discovered.
