...
After you xref:runtime-manager:servers-create.adoc[add a server] and xref:deploying-to-your-own-servers.adoc[deploy an application] to it, you can use the Runtime Manager to monitor and manage your application.
