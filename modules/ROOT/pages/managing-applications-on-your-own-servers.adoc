...
Runtime Manager doesn't support downloading the app archive (ZIP or JAR file) from the application *Settings* page for an app deployed to an on-premises server.
