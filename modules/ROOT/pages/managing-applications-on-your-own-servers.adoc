...
Runtime Manager doesn't support downloading the application archive (ZIP or JAR file) for an app deployed to an on-premises server from the application *Settings* page.
