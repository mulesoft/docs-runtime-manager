...
After you have xref:managing-servers.adoc#add-a-server[added a server] and xref:deploying-to-your-own-servers.adoc[deployed an application] to it, you can use the Runtime Manager to monitor and manage your application.
...
With applications deployed to xref:managing-applications-on-your-own-servers.adoc[your own servers] you can do the following:
...
What this dashboard displays depends on if your application is deployed on xref:managing-applications-on-cloudhub.adoc[CloudHub] or on xref:managing-applications-on-your-own-servers.adoc[a Mule server].
...
* The *Insights* button, to see data at a transaction level. See xref:insight.adoc[Insight] for more info about what you can see here.
+
