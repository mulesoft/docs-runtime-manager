...
The Runtime Manager Agent provides a simple way of implementing internal handlers with buffering support. This document explains how to implement and configure buffers for Runtime Manager Agent internal handlers.
