= Tutorial: Creating an Anypoint Virtual Private Cloud with Anypoint Platform CLI
...
. Set the IP range to allow all only hosts from insde your Anypoint VPC by setting `10.111.0.0/24`. +
...
* Learn how to associate a load balancer to this Anypoint VPC following the xref:dedicated-load-balancer-tutorial.adoc[load balancer tutorial].
