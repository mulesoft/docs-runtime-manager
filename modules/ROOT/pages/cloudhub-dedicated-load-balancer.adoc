...
Each DLB unit that you purchase is the equivalent of two workers handling load balancing between CloudHub workers. You can purchase one, two, three, or four load balancer units for a DLB, which equals two, four, six, or eight workers respectively. 
