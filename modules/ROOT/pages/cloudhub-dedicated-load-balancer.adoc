...
For existing DLBs that use static IP addresses, the original static IP addresses will continue to be used on restart of the DLB unless opted-in using the *Update...* button. The Runtime Manager *Load Balancers* page displays *Update Required* until you update the DLB:
