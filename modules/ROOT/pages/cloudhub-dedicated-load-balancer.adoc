...
[NOTE]
For DLBs created before July 2021, click the *Update* button to avail the feature. After clicking *Update*, the DLB uses static IP model described above and you cannot revert to the old model. The Runtime Manager *Load Balancers* page displays *Update Required* until you update the DLB.
