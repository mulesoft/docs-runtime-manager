...
The CloudHub dedicated load-balancer service enables you to automate provisioning infrastructure components. You can use this service to deploy one or more dedicated load-balancers within an Anypoint Virtual Private Cloud (VPC).

CloudHub dedicated load balancers are an optional component of Anypoint Platform. 
...
To create and configure a load balancer, your profile must be an administrator of the organization to which the load balancer is associated.
