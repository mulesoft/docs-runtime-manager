...
[NOTE]
For DLBs created before October 2021, click *Update* to enable the feature. After clicking *Update*, the DLB uses the static IP model described above, and you cannot revert to the old model.
