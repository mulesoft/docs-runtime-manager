...
Each Dedicated Load Balancer Unit Purchased equals `two` workers handling load balancing between Cloudhub workers. You can pick from 1, 2, 3 or 4 load balancer units for a Dedicated Load Balancer which would equal 2, 4, 6 or 8 workers respectively. 
