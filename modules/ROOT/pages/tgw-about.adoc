...
A _transit gateway_ is a network hub that connects your on-premises networks to your VPCs.
...
You can add multiple transit gateway attachments, depending on your account entitlements....
