...
** Create, update, retrieve a notification.
** Mark a notification as read or unread.
** Create, update, or delete an alert triggered by an application.
** Retrieve an alert and alert history.

* Manage load balancers:
** Create, update, delete a load balancer.
** List load balancers in an organization.
** Test load balancer rules and return the number of the rule number applied to the input.
