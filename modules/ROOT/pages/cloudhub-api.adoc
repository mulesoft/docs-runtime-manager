...
|502 |The operation was unsuccessful due to rate lmit. 

Please refer to the RAML specs in https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/cloudhub-api/[CloudHub API Portal] for more information.
|===
