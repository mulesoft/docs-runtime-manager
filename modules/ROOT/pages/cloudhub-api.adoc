...
* The following end points have a limit of one call per second for each application:
...
* The following end point has a limit of one call per minute for each application:
