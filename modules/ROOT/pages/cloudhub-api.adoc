...
=== Global Rate Limits for CloudHub Platform Management APIs 
...
The following table lists the exceptions to the <<Global Rate Limits for CloudHub Platform Management APIs>>. 
