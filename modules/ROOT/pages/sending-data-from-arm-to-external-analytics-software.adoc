...
. In your API gateway standalone directory, find the `conf/wrapper.conf` file.
. Make sure that the following property is set to `true` and that the line is uncommented:
+
