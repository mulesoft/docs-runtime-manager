...
* Mule v3.6 or above, or API gateway standalone version 2.1.0 or above if you deal with apps that are built with the API gateway.
...
[NOTE]
Although you can set values for the Splunk index, Splunk source and Splunk source type when registering your data input in your Splunk account, the values are overwritten by the values you configure for these fields in the *Advanced* section of the Agent Plugins menu.
