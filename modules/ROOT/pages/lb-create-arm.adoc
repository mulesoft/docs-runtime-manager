...
* *Keep URL encoding* specifies to encode all UTF-8 characters in the DLB URLs.
+
If you deselect this option, only the space (`%20`) and hash (`%23`) special characters are encoded in the DLB URLs.
