= Update All Notifications with the CloudHub API
...
[TIP]
These examples call the xref:cloudhub-api.adoc[CloudHub API]. For instructions on how to perform these same tasks more easily using the Runtime Manager UI, see xref:cloudhub.adoc[CloudHub] and its child pages.
