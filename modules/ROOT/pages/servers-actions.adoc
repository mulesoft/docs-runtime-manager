...
After shutting down the server, it cannot be restarted from Runtime Manager. You must manually restart the server on the machine where the Mule runtime engine is installed.
...
* xref:servers-create.adoc[To Renew a Server Certificate]