...
These updates provide the latest OS and security patches.
To keep your apps up-to-date and secure, apply the updates when they become available.
...
When a new version is available and CloudHub application updates are required, the *Applications* page displays a banner and the *Update Required* tab lists the apps that require updates:
