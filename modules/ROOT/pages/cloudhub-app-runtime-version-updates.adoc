...
For example, CloudHub applies updates to production apps deployed in the Asia-Pacific (Sydney) region in the AEST time zone and sandbox apps deployed in the US West region in the PST time zone.
+
