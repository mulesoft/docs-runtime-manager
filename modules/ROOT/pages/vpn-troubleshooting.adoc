...
IPSec is established by sending interesting traffic. If there is no interesting traffic, the tunnel disconnects when the timers expire. This is the expected behavior.
