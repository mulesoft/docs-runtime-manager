...
For an interactive reference of all the operations that are supported through the API, see https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/arm-rest-services[Runtime Manager REST API].

The Runtime Manager REST API only manages on-prem applications deployed to your servers. To manage apps deployed to CloudHub using the API, see https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/cloudhub-api/[CloudHub API].

== See Also

* xref:managing-servers.adoc[Servers, Server Groups, and Clusters]
* xref:deploying-to-your-own-servers[Deploying to Your Servers]
* xref:managing-applications-on-your-own-servers[Managing Applications on Your Servers]
