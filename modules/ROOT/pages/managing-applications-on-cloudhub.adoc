...
. After you've made the change, click *Apply changes*. Here's an example using the text format:
+
image::setproperties.png[Set Properties]
+
Here is another example using the list format:
...
=== Upgrade Application's Mule Version

If your application is running on an older version of the Mule Version selected, you can upgrade your application to use the latest update of that Mule Version. In order to upgrade use the Runtime Version dropdown and select the version that says **New** next to it and click Apply Changes

Pro Tip: For updating multiple apps together you can use the bulk operation API documented xref:https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/cloudhub-api/1.0.13/console/method/%231545/[here]
