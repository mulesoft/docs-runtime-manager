...
[NOTE]
If you are using Chrome's password autofill feature and you have a username for anypoint.mulesoft.com that matches a variable you wish to define/update, Chrome will overwrite your configured value for the variable with the password stored in Chrome for the username that matches the variable. 
This is a limitation, please use incognito mode or use a different browser in this case.
...
CloudHub also supports xref:secure-application-properties.adoc[safely hiding application properties] to protect sensitive information.
