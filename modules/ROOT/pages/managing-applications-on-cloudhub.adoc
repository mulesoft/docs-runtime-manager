...
[IMPORTANT]
By default, all applications are limited to no more than four workers of any size. Free and professional accounts are limited to a single worker per app. If you need more workers or more total vCore capacity, update your subscription. If you need more than four workers for a single domain, https://help.mulesoft.com[contact MuleSoft] directly.
