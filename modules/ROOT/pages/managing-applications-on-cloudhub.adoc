...
What this dashboard displays depends on if your application is deployed on xref:cloudhub.adoc[CloudHub] or on xref:managing-applications-on-your-own-servers.adoc[a Mule server].
