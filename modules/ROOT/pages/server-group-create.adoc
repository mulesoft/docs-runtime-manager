...
To deploy applications to a server group, you can either add the servers to Runtime Manager first, then create the server group or you can create the group and add servers to it later.
