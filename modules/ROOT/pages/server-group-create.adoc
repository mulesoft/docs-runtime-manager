...
To deploy applications to server groups, you can either create the servers first, then create the server group or you can create the group and add servers to it later.
