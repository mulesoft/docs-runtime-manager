...
[NOTE]
If required, you can create multiple VPNs to connect to different networks or different regions within a network. The number of VPNs you can create depends on the VPN capacity allocated to your account. Contact your MuleSoft account representative to discuss your requirements.
