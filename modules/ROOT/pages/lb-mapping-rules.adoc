...
The *Output Path* (`appURI`) cannot contain patterns.
...
+
The protocol on which the application listens: `http` (port 8091), `https` (8092), `ws` WebSockets (8091), or `wss` Web Service Security (8092).
+
