...
+
If you are using MuleSoft Government Cloud, you can deploy Mule runtime engine to a private cloud or on-premises environment and manage your app deployments using your MuleSoft Government Cloud control plane. Refer to xref:docs-gov-cloud::gov-cloud-standalone.adoc[Standalone Mule Support] for MuleSoft Government Cloud requirements.
