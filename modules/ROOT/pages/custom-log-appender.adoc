...
IMPORTANT: MuleSoft Support doesn't provide assistance for implementing custom logging configurations, nor resolving issues caused by custom logging configurations.
