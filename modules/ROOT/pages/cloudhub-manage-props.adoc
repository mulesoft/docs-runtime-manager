...
In a CloudHub deployment, you can add properties to an application using Anypoint Runtime Manager or a properties file.

If you set properties both in the properties file in your application and in Runtime Manager, the values set in Runtime Manager always override the values in properties file when your application deploys.
...
+
See xref:mule-runtime:3.9:configuring-properties.adoc[Configuring Properties].

CloudHub then loads these properties or property placeholders into the application when the application starts. 
