...
[IMPORTANT]
====
Enabling Insight has a performance impact when application data is processed. Do not enable Insight for long periods of time for production environments. To monitor a production environment, use the tools listed in the xref:monitoring.adoc[monitoring section].
