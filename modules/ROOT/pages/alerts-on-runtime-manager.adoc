...
* An application exceeds a specific number of events processed within a given timeframe.
* A deployment is complete, either successfully or not. 
* The worker monitoring system notifies CloudHub about a problem with the worker on an application.
