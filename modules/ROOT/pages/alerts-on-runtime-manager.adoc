...
.6+|| *Application undeployed* a| `${name}` 
| *Deployment failure* a| `${name}` 
| *Deployment success* a| `${name}` 
| *Number of Mule messages* a|  `${name}` `${currentValue}` `${threshold}` `${location}`
| *Number of errors* a| `${name}` `${currentValue}` `${threshold}` `${location}`
| *Response time* a|  `${name}` `${currentValue}` `${threshold}` `${location}`

2+| *All Server Alerts* | `${name}`

3+|*Servers*
.9+||*Agent version changed* a|  `${oldVersion}` `${newVersion}`
...
3+|*Server Groups*
.11+|| *Server Group connected* a|  `${name}` 
| *Server Group deleted* a|`${name}` 
| *Server Group disconnected* a|  `${name}` 
| *Server Group's node CPU usage* a|  `${name}` `${memberName}` `${groupName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Server Group's node Load average* a|  `${name}` `${memberName}` `${groupName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Server Group's node Memory usage* a| `${name}` `${memberName}` `${groupName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Server Group's node Thread count* a| `${name}` `${memberName}` `${groupName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Server Group's node connected* a|  `${name}`  `${memberName}` `${groupName}`
| *Server Group's node disconnected* a|  `${name}`  `${memberName}` `${groupName}`
| *Server added to Server Group* a|  `${name}`  `${memberName}` `${groupName}`
| *Server removed from Server Group* a| `${name}`  `${memberName}` `${groupName}`


3+|*Clusters* 
.12+||*Cluster connected* a|  `${name}` 
| *Cluster deleted* a|  `${name}` 
| *Cluster disconnected* a|  `${name}` 
| *Cluster presents visibility issues* a|  `${name}` 
| *Cluster's node CPU usage* a|  `${name}` `${memberName}` `${clusterName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Cluster's node Load average* a| `${name}` `${memberName}` `${clusterName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Cluster's node Memory usage* a| `${name}` `${memberName}` `${clusterName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Cluster's node Thread count* a| `${name}` `${memberName}` `${clusterName}` `${currentValue}` `${comparison}` `${threshold}` `${location}` `${parentResource}` `${parentLocation}`
| *Cluster's node connected* a| `${name}` `${memberName}` `${clusterName}`
