...
// add cloudhub 2.0 alerts - deployment success and deployment failure
...
.7+| CloudHub 1.0 App Alerts |*CPU usage - CloudHub* .2+|`${operator}` `${value}`
| *Memory usage - CloudHub*
...
* CloudHub 2.0 Apps: Name of the app that triggers the alert
...
* CloudHub 1.0 Apps: Name of the app that triggers the alert
* CloudHub 2.0 Apps: ID of the app that triggers the alert
* Hybrid Apps: ID of the resource in the app that triggers the alert
