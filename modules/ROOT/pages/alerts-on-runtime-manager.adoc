...
* *Application type*
+
When the source is *Applications*, applications deployed to either CloudHub or local servers. Runtime Fabric application alerts are only supported using Anypoint Monitoring.
+
