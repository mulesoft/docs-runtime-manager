...
This document focuses on deploying to the Cloud Foundry, for more information on deploying to servers, server groups and clusters, see xref:deploying-to-your-own-servers.adoc[Deploying to Your Own Servers].
...
* xref:runtime-manager-api.adoc[Runtme Manager API]