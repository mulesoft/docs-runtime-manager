...
Deploying applications to servers in server groups provides redundancy so that applications can be restored more seamlessly and quickly with less downtime.   
