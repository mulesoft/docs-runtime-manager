...
. To edit a rule, you can modify existing values. select the new values from the *Type* and *Source* drop-down lists, and enter the value for the *Port Range*.
...
[NOTE]
--
There is not a confirmation dialog when you delete a firewall rule, so make sure you really want to delete it.
--
