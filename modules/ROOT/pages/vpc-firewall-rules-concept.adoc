...
You can create up to 60 VPC firewall rules. 

If you create more than 60 firewall rules, the VPC returns an error, indicating that you have reached the maximum number of rules.
