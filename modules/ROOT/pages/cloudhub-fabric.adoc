...
Object stores in your applications are also always stored persistently using DynamoDB, even if you did not enable Persistent queues for your application.
