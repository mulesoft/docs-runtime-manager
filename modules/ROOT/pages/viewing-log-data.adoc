...
[NOTE]
Downloading logs using this approach or it's API is not the recommended way to extract Cloudhub Application Logs. Please use xref:custom-log-appender.adoc[Custom Log Appender] to extract logs.
