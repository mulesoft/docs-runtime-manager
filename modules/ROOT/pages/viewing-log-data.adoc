...
[NOTE]
If CloudHub application logs need to be archived or downloaded for audit, analytics or similar purpose on regular intervals, use xref:custom-log-appender.adoc[Custom Log Appender] to extract logs.
