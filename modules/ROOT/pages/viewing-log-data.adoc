...
[NOTE]
If Cloudhub Application Logs need to be archived/ downloaded for audit, analytics or similar purpose on regular intervals, please use xref:custom-log-appender.adoc[Custom Log Appender] to extract logs.
