...
+
The console displays the application logs.
...
For each worker in a CloudHub deployment, you can download separate logs:
...
CloudHub downloads the log output to a text file with the extension `.log` in the format `__deploymentID__.__instanceID__-__workerNumber__.log`.
You can view the log file with a text editor.
...
CloudHub downloads the diagnostic output to a text file with the extension `.txt` in the format `__appName__-instance-__instanceID__-__workerNumber__-diag.txt`. 
You can view this file with a text editor.
...
CloudHub downloads the Mule log output to a text file with the extension `.log` in the format `__appName__-instance-__instanceID__-__workerNumber__-mule_ee.log`.
You can view the log file with a text editor.
