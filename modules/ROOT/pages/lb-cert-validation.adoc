...
[NOTE]
--
We recommend you use the CloudHub REST API to programmatically update your revocation lists. +
...
Each one of the recommended ciphers suites listed have a good balance between compatibility and security for your SSL endpoint
offer forward secrecy, except RC4-SHA which is there to support Internet Explorer 8.
...
CloudHub's dedicated load balancer supports TLSv1.1 and TLSv1.2. Additionally, you can configure TLS v1.0. However, TLS v1.0 is no longer accepted by PCi compliance due to its significant vulnerabilities.
