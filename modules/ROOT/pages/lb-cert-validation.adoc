...
To add a revocation list when you create the load balancer, use the `--crl` option with the xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-load-balancer-create[`cloudhub load-balancer create`] command.
...
To get the values for `myVpcID` and `myDlbID` values from the CLI, use the xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-vpc-describe-json[`cloudhub vpc describe-json`] and xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-load-balancer-describe-json[`cloudhub load-balancer describe-json`] commands.
...
+
See xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-vpc-describe-json[cloudhub vpc describe-json].
* Retrieve your DLB ID using the CloudHub CLI.
+
See xref:anypoint-cli::anypoint-platform-cli-commands.adoc#cloudhub-load-balancer-describe-json[cloudhub load-balancer describe-json].
