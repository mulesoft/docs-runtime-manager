...
After you deploy your application, you can use the monitoring dashboards in Runtime Manager to monitor the application's performance. If you deployed the application to an on-premises server, you can also monitor the server. 
