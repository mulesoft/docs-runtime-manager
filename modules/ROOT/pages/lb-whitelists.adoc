...
If you want to allow IP addresses access to your dedicated load balancer (DLB), you must add those IP addresses to the DLB in CIDR notation.
...
== Add an IP address to the Whitelist of an Existing Load Balancer
