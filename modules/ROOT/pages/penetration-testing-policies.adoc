...
+
For information about how to complete the request form, see the knowledge article https://help.salesforce.com/articleView?id=000322336&type=1&mode=1[Complete the Security Assessment submission form].
...
on your workers but not other Anypoint Platform services.
...
+
The following documents help the reviewer identify common false positives or security issues related to settings:
+
--
...
+
--
For information about how to submit a security vulnerability finding, see the 
