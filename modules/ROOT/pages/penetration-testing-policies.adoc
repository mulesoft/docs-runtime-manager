...
. Navigate to: https://security.secure.force.com/securityassessments and click on *Sign-in with SecureAssess* if you don't have a Salesforce account.
...
[NOTE]
If preferred, you can manually send your completed https://content.api.getguru.com/files/view/fbf972df-460b-4881-b84b-94d2cd3efc72[Security Assessment Request .pdf form] to mailto:securityassessment@salesforce.com[securityassessment@salesforce.com].
