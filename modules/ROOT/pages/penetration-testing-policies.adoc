...
Before initiating penetration testing, enable static IPs for the app.
...
To request a Security Assessment, follow the steps in the https://help.salesforce.com/articleView?id=000336416&type=1&mode=1[Salesforce Security vulnerability assessment and penetration test]:

. https://help.salesforce.com/articleView?id=000322336&type=1&mode=1[Complete the Security Assessment submission form]. 
. Before following up with Salesforce, assign a security resource at your company to review and validate your findings.
+
[IMPORTANT]
