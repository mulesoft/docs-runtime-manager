...
. Navigate to https://security.secure.force.com/securityassessments and click *Sign-in with SecureAssess* if you don't have a Salesforce account.
. Select *New User* and register your details. Once registered and approved, you'll be able to log in to the portal and submit your pen test request.
...
+
For further information about completing the request form, see https://help.salesforce.com/articleView?id=000322336&type=1&mode=1[Complete the Security Assessment].

[NOTE]
If preferred, you can also send your completed https://content.api.getguru.com/files/view/fbf972df-460b-4881-b84b-94d2cd3efc72[Security Assessment Request manual form] to mailto:securityassessment@salesforce.com[securityassessment@salesforce.com].
