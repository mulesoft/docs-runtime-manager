...
|image:logo-cloud-disabled.png[link="/runtime-manager/deploying-to-cloudhub", title="CloudHub"]

|Hybrid
|image:logo-hybrid-active.png[link="/runtime-manager/deploying-to-your-own-servers", title="Hybrid"]
|image:logo-hybrid-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Hybrid"]

|Anypoint Platform Private Cloud Edition 
|image:logo-server-active.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform PCE"]
|image:logo-server-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform PCE"]
...
image:logo-cloud-active.png[link="/runtime-manager/deploying-to-cloudhub", title="CloudHub"]
image:logo-hybrid-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Hybrid"]
image:logo-server-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform Private Cloud Edition"]
image:logo-rtf-disabled.png[link="/runtime-fabric/deploy-to-runtime-fabric", title="Anypoint Runtime Fabric"]
...
* *Load balancing*
+
If your app runs on multiple workers, the CloudHub shared load automatically balances incoming traffic evenly.
+
...
image:logo-hybrid-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Hybrid"]
image:logo-server-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Anypoint Platform Private Cloud Edition"]
image:logo-rtf-active.png[link="/runtime-fabric/deploy-to-runtime-fabric", title="Anypoint Runtime Fabric"]
...
* *Load balancing*
+
Runtime Fabric does not include the load balancing feature. 
You can manage load balancing with the tools connected to your infrastructure.

* *Logging*
+
Runtime Fabric uses Ops Center to view and configure logs. 
You can use forward logs from Runtime Fabric to a rsyslog server.
+
See xref:runtime-fabric::runtime-fabric-logs.adoc[View and Configure Logging in Runtime Fabric].

* *Monitoring*
+
Runtime Fabric provides dashboards and alerts in Ops Center for viewing performance and availability metrics. To receive and send alerts, use an SMTP server.
+
See https://docs.mulesoft.com/runtime-fabric/1.4/configure-alerting.adoc[Configure Alerting on Runtime Fabric].
+
You can also use Anypoint Monitoring to view application metrics with Anypoint Platform.
+
See xref:runtime-fabric::manage-monitor-applications.adoc[Monitoring Applications Deployed to Runtime Fabric].

* *Object store*
+
Runtime Fabric does not support Object Store.
...
* *Troubleshooting*
+
Runtime Fabric does not include the Insight troubleshooting tool. 
Instead, use the command-line tools provided to obtain the health status of the cluster and components.
+
See xref:runtime-fabric::troubleshoot-guide.adoc[Troubleshooting Guide for Runtime Fabric].
