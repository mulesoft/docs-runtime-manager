...
|xref:runtime-fabric::deploy-to-runtime-fabric.adoc[Runtime Fabric]
...
If the content doesn't apply to a deployment strategy, the icon appears grayed out:

image:logo-cloud-disabled.png[link="/runtime-manager/deploying-to-cloudhub", title="CloudHub"]
image:logo-hybrid-disabled.png[link="/runtime-manager/deploying-to-your-own-servers", title="Hybrid Deployment"]
