...
+
See xref:monitoring.adoc[Monitor Applications and Servers].

* *Object store*
+
CloudHub provides a preconfigured default object store that you can reference using Anypoint Connector for Object Store.
+
See xref:managing-application-data-with-object-stores.adoc[Manage Application Data Storage with Object Stores].
+
...
+
See xref:managing-schedules.adoc[Manage Schedules].
...
To use the hybrid option, you first register your Mule servers with the Runtime Manager agent.
...
To use the Anypoint Platform PCE option, you first register your Mule servers with the Runtime Manager agent.
...
+
See xref:runtime-fabric::install-prereqs.adoc#additional-resource-requirements-for-production-environments[Additional Resource Requirements for Production Environments].
* *Logging*
+
...
+
See xref:runtime-fabric::configure-alerting.adoc[Configure Alerting on Runtime Fabric].
