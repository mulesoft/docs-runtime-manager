...
Anypoint-CLI is a NodeJS application. To install Anypoint Platform CLI on your computer you need to make sure that you have the NodeJS runtime environment installed on your computer, along with NPM, the default Node.js package manager.
