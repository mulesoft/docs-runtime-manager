...
To use Anypoint CLI through a proxy server, configure the `HTTP_PROXY` and `HTTPS_PROXY` environment variables with the IP addresses for your proxy servers, for example:

* Linux, macOS, or Unix:
+
[source,text,linenums]
----
$ export HTTP_PROXY=http://192.0.2.0:80
$ export HTTPS_PROXY=https://198.51.100.0:443
----
...
[source,text,linenums]
----
> set HTTP_PROXY=http://192.0.2.0:80
> set HTTPS_PROXY=https//198.51.100.0:443
----
...
[source,text,linenums]
----
$ export HTTP_PROXY=http://username:password@192.0.2.0:80
$ export HTTPS_PROXY=https://username:password_@198.51.100.0:443
----
...
[source,text,linenums]
----
> set HTTP_PROXY=http://username:password@192.0.2.0:80
> set HTTPS_PROXY=https://username:password@198.51.100.0:443
----
