...
To add a new Flex gateway, follow the instructions described in the UI:
...
For detailed instructions on how to add a new gateway, see xref:beta-flex-gateway-ga::flex-install.adoc[Install Flex Gateway].
