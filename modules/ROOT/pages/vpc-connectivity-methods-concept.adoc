...
You can attach Anypoint VPN to your private network using your existing transit gateway.

A transit gateway attachment enables you to connect multiple VPCs to your private network and route traffic between them.
...
To attach a transit gateway to your network, see xref:tgw-about.adoc[Transit Gateway Attachments].
