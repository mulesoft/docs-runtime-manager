...
The process for requesting or updating Anypoint Virtual Private Cloud (Anypoint VPC) connectivity to your network depends on the connectivity method you use: IPsec, transit gateway attachments, VPC peering, or Direct Connect.
...
== Configure Transit Gateway Attachment Connections

For transit gateway attachments, follow the self-service steps in 
