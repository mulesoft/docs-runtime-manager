...
During installation, you also have the option to configure the Runtime Manager agent using a quick-start script. For details, see xref:installing-and-configuring-runtime-manager-agent.adoc[installing and configuring the Runtime Manager agent]
