...
During installation, you also have the option to configure the Runtime Manager Agent via a quick-start script. For details, see xref:installing-and-configuring-runtime-manager-agent.adoc[installing and configuring Runtime Manager Agent]
