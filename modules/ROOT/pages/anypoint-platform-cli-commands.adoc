...
[NOTE]
This command only uploads a file to an existing project in your Design Center. It does not create a new project if it does not exist. To create a new project, use the `designcenter project create` command.
