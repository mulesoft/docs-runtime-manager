...
[NOTE]
This command uploads the files included in the directory specified in the `projDir` parameter to an existing project in your Design Center. It does not create a new project if it does not exist. To create a new project, use the `designcenter project create` command.
