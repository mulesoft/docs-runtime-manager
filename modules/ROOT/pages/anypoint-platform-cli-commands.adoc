...
* <<Commands for Managing Anypoint DataGraph Load Balancer>>
...
|===
|Command |Description
| <<datagraph load-balancer-config add>> | Adds a new Anypoint DataGraph load balancer
| <<datagraph load-balancer-config remove>> | Removes a Anypoint DataGraph load balancer
|===
...
----
This command adds the dedicated load balancer configuration specified by `<dlbUrl>` to Anypoint DataGraph.
...
This command displays the dedicated load balancer URL for Anypoint DataGraph.
