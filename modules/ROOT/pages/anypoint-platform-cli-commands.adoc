...
|<<exchange asset mutableDataUpload>> | Modifies mutable data of an existing asset
...
This command modifies the mutable data (tags, categories, fields and documentation) of an already created asset. 
...
|===
| Command | Description |  Example
| `--docs` | Documentation file. (Should specify the the "zip" file path. E.g. "--docs /.../file-path/docs.zip") |
