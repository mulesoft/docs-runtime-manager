...
== Commands for Managing Your Local Anypoint Platform for Pivotal Cloud Foundry (PCF) Deployed Applications
...
You can start typing your application's name and press `tab` for Anypoint-ClI to autocomplete it, or you can double tap `tab` for a full list of all the values you can pass. +
This command does not take any options, except for the default ones: `--help`, `-f`/`--fields` and `-o`/`--output`.
...
You can also start typing your option and press `tab` for Autocomplete-CLI to autocomplete it for you.
...
You can start typing your load balancer's name andpress`tab` for Anypoint Platform CLI to autocomplete it, or you can double tap `tab` for a full list of all the values you can pass. +
