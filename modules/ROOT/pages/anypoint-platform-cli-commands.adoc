...
The `identifier` parameter specifies the application identifier. For information about using the Runtime Manager REST API to retrieve the identifier for applications deployed on-premises, see 
https://help.mulesoft.com/s/article/How-to-get-a-list-of-applications-via-Anypoint-Platform-APIs[How to get a list of applications via Anypoint Platform APIs].
