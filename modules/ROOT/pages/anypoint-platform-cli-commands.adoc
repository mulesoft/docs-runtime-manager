...
[%header,cols="30,50a,30a"]
|===
|Value |Description | Example
| `--insight` | Stores message metadata of every Mule transaction. |
| `--log [level:scope]` | Setx the logging level and scope pair:
...
To set multiple logging levels, provide multiple `--log` options.| `--log INFO:org.apache
