...
[IMPORTANT]
The flow metrics feature was deprecated on Dec 9th, 2019. Customers are encouraged to use xref:monitoring::index.adoc[Anypoint Monitoring] for this functionality.
