...
[IMPORTANT]
MuleSoft deprecated the flow metrics feature on Dec 9th, 2019. You can use xref:monitoring::index.adoc[Anypoint Monitoring] to get metrics for flows in your apps.
