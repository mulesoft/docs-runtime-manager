...
[IMPORTANT]
MuleSoft deprecated the flow metrics feature on Dec 9th, 2019. We recommend that you use xref:monitoring::index.adoc[Anypoint Monitoring] to monitor your apps and APIs.
