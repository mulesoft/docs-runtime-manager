...
Configure your xref:to-request-vpc-connectivity.adoc[Anypoint VPN] to connect the Anypoint VPC to your on-premise network. If you will be connecting your Anypoint VPC using VPC Peering or CloudHub Direct Connect, this must be done by a MuleSoft representative.
