...
xref:tgw-about.adoc[transit gateway] to connect the Anypoint VPC to your on-premise network.
+
To connect your Anypoint VPC using VPC Peering or CloudHub Direct Connect, contact your MuleSoft Support representative.
