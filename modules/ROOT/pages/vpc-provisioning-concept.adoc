...
[NOTE]
--
To avoid unnecessary downtime, it is critical to define the VPC settings during the initial setup of the VPC. +
...
You cannot share a VPC created by a business group with another business group higher in the hierarchy.

It's recommended that you create your VPC in your master organization, and share it with the other business groups.
