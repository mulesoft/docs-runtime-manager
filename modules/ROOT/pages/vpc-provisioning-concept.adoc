...
[NOTE]
VPN licenses do not need to have a one-to-one relationship with the VPC licenses. For example, you can have two VPCs with two VPNs in one of them and none in the other. 
