...
=== Is there a limit on the number of applications I can have?

Yes, apart from vcores, Cloudhub limits the number of applications per environmnet per organization. This limit is calculated multiplying the environment vCores allocation by 20. For instance, if you have a Sandbox environment with a 2 vCores allocation, you will be able to have up to 20 0.1 vCores running applications and up to 20 0.1 vCores not-running applications in the same environment at the same time. 
