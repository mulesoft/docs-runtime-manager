...
This limit is calculated by multiplying the environment vCores allocation by 20.
For instance, if your Sandbox environment has 2 vCores allocated, you can have a total of 40 0.1 vCores applications (20 0.1 vCores running applications and 20 0.1 vCores not-running applications) in the same environment at the same time. 
