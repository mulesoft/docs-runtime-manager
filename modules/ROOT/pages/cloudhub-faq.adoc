...
. Sign into the Anypoint Platform, then click *Support* on the top navigation bar.
. Click the *Cases* tab.
+
...
+
Provide a detailed description of your issue and any supporting information. Hover over icons for field-specific guidelines or instructions. 
...
When your subscription expires, *any existing running workers continue to run* (_should we say this??_). However, you can't create new apps or restart existing apps.
