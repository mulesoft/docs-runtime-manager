...
Using xref:studio::index.adoc[Anypoint Studio (Studio)], you can build integration applications and deploy them to CloudHub with just a few clicks. See xref:deploying-to-cloudhub.adoc#deploy-an-application-from-studio[Deploy an Application from Studio] for more information.
