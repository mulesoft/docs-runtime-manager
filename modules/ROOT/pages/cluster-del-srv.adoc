...
You can remove a server from a cluster without affecting the server.

[IMPORTANT]
When you remove a server from a cluster, all existing servers in the cluster are restarted.
