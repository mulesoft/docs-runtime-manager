...
You can set your own xref:cloudhub-dedicated-load-balancer.adoc[dedicated load balancer] through the xref:anypoint-platform-cli.adoc[Anypoint Platform CLI] by configuring your own xref:virtual-private-cloud.adoc[Anypoint VPC].
