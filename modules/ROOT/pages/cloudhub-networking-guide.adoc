...
.https://anypoint.mulesoft.com[U.S. Control Plane]
[%header,cols="2*a"]
|===
| Regions in US Control Plane | DNS Record 
...
Though the EU control plane supports some of the same regions 
that the U.S. control plane supports, the DNS records are different. 
For more on the EU control plane, see 
xref:eu-cloud:index.adoc[About the EU Control Plane].

.https://eu1.anypoint.mulesoft.com[EU Control Plane]
[%header,cols="2*a"]
|===
