...
* Multicast servers can be in the status states] *Running* or *Disconnected*, whereas unicast servers can only be in the state *Running*. They can't be in *Created* state.
