...
+
The command includes the unique `server-name` used to label Mule in the Runtime Manager console.
This value is unique across environments and can be the same for the same organization in different environments.
+
