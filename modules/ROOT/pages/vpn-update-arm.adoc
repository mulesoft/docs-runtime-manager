...
You can set the *Initiator Mode* for Anypoint VPN. When enabled, your Anypoint VPN initiates IKE negotiation to bring tunnels up. If you decide to use this feature:
