...
[TIP]
Before you can deploy to a server, you must first xref:3.8@mule-runtime::installing.adoc[install] Mule and then xref:managing-servers.adoc#add-a-server[register it on the platform].
