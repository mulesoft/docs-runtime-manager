...
The values of properties defined on the *Settings* page override any application properties defined in `mule-app.properties` or other properties of Mule.
...
== Add Application Properties Using the mule-app.properties File

The most common method to add properties to an app is to include a `mule-app.properties` file containing the properties in the deployable application archive file.
