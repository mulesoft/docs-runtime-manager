...
In an on-premises (hybrid or Anypoint Platform PCE) deployment, you can add properties to an application using a properties file or Anypoint Runtime Manager.
...
Mule runtime engine then loads these properties or property placeholders into the application when the application starts.
