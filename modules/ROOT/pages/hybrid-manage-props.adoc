...
The most common method to add properties to an app is to include a `mule-app.properties` file in the application .zip bundle.
Mule runtime engine then loads these properties into the application when the application starts.


== Define Properties in Runtime Manager
