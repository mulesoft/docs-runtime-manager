...
For High downtime risk VPNs, deploy a xref:vpn-high-availability.adoc[high-availability VPN] solution to avoid any downtime associated with AWS-delivered auto-updates. Refer to xref:vpn-maintenance.adoc[VPN Maintenance] for more details.
...
The downtime risk associated with your VPNs is shown in Anypoint Platform.
