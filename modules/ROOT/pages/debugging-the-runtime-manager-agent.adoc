...
If you experience issues with the Runtime Manager Agent Plugin or with managing applications on Anypoint Platform, you should run and obtain the output of this script before filing a support ticket.
