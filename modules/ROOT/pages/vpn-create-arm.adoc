...
You must open a ticket on https://support.mulesoft.com/[Support Center] requesting to enable the VPN feature in your organization before you can see this option under your account's menu.
After VPN is enabled, you need to assign the VPN licenses to your Business Group under *Access Management* menu, so you will be able to see *VPN* menu item under *Runtime Manager*.
