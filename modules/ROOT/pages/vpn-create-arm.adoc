...
.. In the *Download VPN Config* window, select a Vendor, Platform, and Software version that corresponds to your VPN endpoint. 
+
If your device type is not listed, select the *generic* option.
.. Click *View Config* and then click *Copy* in the top right corner, and paste the configuration to a text file. 
+
...
+
.. Share the configuration file with your VPN endpoint administrator.
..  Based on the VPN options you choose, you might need to perform additional configuration steps.
+
