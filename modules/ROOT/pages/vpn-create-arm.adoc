...
+
.. Share the Anypoint VPN configuration file with your VPN endpoint administrator.
.. Based on the Anypoint VPN configuration, you might need to perform additional configuration steps.
+
