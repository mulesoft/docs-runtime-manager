...
You can manage these settings from the xref:access-management::index.adoc[Access Management] section in your Anypoint Platform.
...
Note that there is not a 1:1 relationship between workers and applications. For more information on Worker Sizing, see xref:cloudhub-fabric.adoc[CloudHub Fabric] and xref:deploying-to-cloudhub.adoc#worker-sizing[Deploying to CloudHub].
--
