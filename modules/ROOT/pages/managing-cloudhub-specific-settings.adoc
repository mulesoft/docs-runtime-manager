...
There is not a 1:1 relationship between workers and applications. For more information on Worker Sizing, see xref:cloudhub-fabric.adoc[Clustering] and xref:deploying-to-cloudhub.adoc#worker-sizing[Deploying to CloudHub].
--
