...
For more information about worker sizing, see xref:cloudhub-fabric.adoc[Clustering] and xref:cloudhub-architecture.adoc#cloudhub-workers[CloudHub Workers].
--
