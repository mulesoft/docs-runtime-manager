...
* The number of transit gateways you can add depends on the network connections available to your Business Group.
+
...
+
[NOTE]
The MuleSoft AWS account ID that appears depends on your platform (US or EU).
