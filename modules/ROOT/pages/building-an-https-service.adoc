...
CloudHub supports building HTTPS- and SSL-based services so you can be sure of your data confidentiality. 
...
Before you begin, build a service and deploy it. It can be a simple Hello World service.
