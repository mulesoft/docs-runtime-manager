...
[NOTE]
--
The configuration steps shown in this document are meant for deploying your Mule 3 app to CloudHub. If you instead intend to deploy your app locally, see xref:3.8@mule-runtime::tls-configuration.adoc[TLS Configuration]. +
...
If you want to build an HTTPS proxy in Mule 4, follow the xref:api-manager::building-https-proxy.adoc[Building an HTTPS API Proxy] instructions.
--
