...
[NOTE]
--
The configuration steps shown in this document are meant for deploying your app to CloudHub. If you instead intend to deploy your app locally, see xref:3.8@mule-runtime::tls-configuration.adoc[TLS Configuration]. +
