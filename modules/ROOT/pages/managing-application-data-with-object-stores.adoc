...
* Object Store v2 provides expanded cloud object store functionality for use with Mule 3.8.5 and later and for Mule 4.
====
...
Object Store v1 has these limits:
...
Object Store v2 has these limits:
...
* Available in 10 regions around the world 
