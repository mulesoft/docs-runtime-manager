...
See xref:gateway::flex-conn-pub-simple-api.adoc#publish-a-simple-api[Publish a Simple API] for more information on how to add an API in API Manager.

== See Also

* xref:flex-gateway-apis.adoc[APIs]
* xref:gateway::flex-gateway-conn-manage.adoc[Managing Flex Gateway in Connected Mode]
