...
* The minimum recommended frequency between calls is 10.
...
* When a schedule is used to trigger a flow with subflow in a Mule 4.x application, the scheduler waits until both main flow and subflow complete before scheduling the next run.
+
