...
+
. Click *Switch to advanced mode* to use Cron expressions, and click *Quick reference* for information on required fields and allowed values.
+
Click *more* to view the Quartz http://www.quartz-scheduler.org/documentation[Quartz documentation]. Select a version, click *Documentation* > *User's Guide* > *Tutorial*, and then click *Lesson 6: CronTrigger*.
+
If you change the Cron setting, click *Update*. Click *Cancel* to exit. Click *Switch to basic mode* to exit advanced mode.
+
