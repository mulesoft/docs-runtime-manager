...
* If the execution time for a job is longer than 12 hours or in the event of network issues or infrastracture restarts/maintenance, the scheduler fails and is re-executed.
