...
+
[NOTE]
By default, schedules run at the frequency defined in the application. When you change the frequency of a schedule from Runtime Manager, the schedule will run at the frequency configured on Runtime Manager even if you update and redeploy the same schedule in the application JAR file.
