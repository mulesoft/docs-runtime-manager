...
Safely hidden application properties are a separate feature and concept from encrypted Mule application properties that are stored in xref:mule-runtime::secure-configuration-properties.adoc[Secure Configuration Properties] files.
