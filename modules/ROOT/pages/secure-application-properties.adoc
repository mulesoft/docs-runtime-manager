...
For applications that you deploy using another deployment option, you must use secure property placeholder files bundled with your application ZIP file.
...
. In the *Applications* page, click the application name, then click *Settings*.
...
* xref:cloudhub-manage-props.adoc[Managing Properties for Applications on CloudHub]
* xref:hybrid-manage-props.adoc[Managing Properties for Applications On-Premises]
