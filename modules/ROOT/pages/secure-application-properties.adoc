...
For applications that you deploy using another deployment option, you must use secure property placeholder files bundled with your application JAR file (Mule 4) or ZIP file (Mule 3).
