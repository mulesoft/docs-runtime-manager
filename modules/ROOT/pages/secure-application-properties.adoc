...
*HERE* I think it's worth mentioning that when override the secured properties in Runtime Manager using Text view, the colon in property name needs to be escaped. For example, secure\:\:someproperty. Or suggest the reader to use List view. It took me hours to figure this out. I am sure I am not the only person followed this document but found it doesn't work.
