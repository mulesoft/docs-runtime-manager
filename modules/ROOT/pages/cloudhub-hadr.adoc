...
The worker buffers any logs and other telemetry data that the runtime plane sends while the control plane is unavailable until availability is restored.
