...
While the control plane is unavailable, the worker buffers up to 1 GB of log data and other telemetry data that the runtime plane sends until availability is restored.
