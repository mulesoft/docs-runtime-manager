...
[IMPORTANT]
As you scale, especially in the cloud, the state and resources used by each worker or node should be independent of other workers. This model ensures better performance and scalability as well as reliability.