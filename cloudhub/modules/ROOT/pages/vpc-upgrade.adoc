...
Absent Internal DNS Special Domains::
Currently, if you do not have internal DNS configured for your VPC, and your VPC has network connections or DLBs, it will not yet be eligible for an upgrade.
