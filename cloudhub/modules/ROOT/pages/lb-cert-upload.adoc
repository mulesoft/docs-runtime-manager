...
[WARNING]
Using RSA 4096-bit certificates can reduce DLB worker performance by up to ten times compared to RSA 2048-bit certificates. Plan DLB sizing accordingly before adding new 4096-bit certificates or updating existing certificates to 4096 bits.
