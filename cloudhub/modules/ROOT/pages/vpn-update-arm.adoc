...
[NOTE]
To update existing IPsec VPN connections that were created by MuleSoft Support before November 2018, see xref:to-request-vpc-connectivity.adoc#configure-ipsec-vpn-connections[Configure IPsec VPN Connections].
