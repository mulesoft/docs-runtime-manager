...
VPC-level network traffic metrics aren't available in Anypoint Monitoring. Application-level traffic metrics are available via the xref:monitoring::index.adoc[Anypoint Monitoring Metrics API].
