...
The Anypoint Virtual Private Cloud (VPC) is a virtual network where your CloudHub applications reside. A VPC allows you to create a virtual, private, and isolated network segment in the cloud to host your CloudHub workers.
