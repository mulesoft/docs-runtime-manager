...
VPC-level network traffic metrics aren't available in Anypoint Monitoring. For _application-level_ traffic metrics, see xref:monitoring:am-faq.adoc#vpc-traffic-metrics[Can I get VPC-level network traffic metrics from Anypoint Monitoring?].
