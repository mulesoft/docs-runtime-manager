...
If there is not a specific *Device Configuration* file downloadable from the *Get VPN Config* menu for any of the listed devices, use the *Generic* VPN configuration file.

image::vpn-device-generic-config.png[Generic VPN configuration file.]
