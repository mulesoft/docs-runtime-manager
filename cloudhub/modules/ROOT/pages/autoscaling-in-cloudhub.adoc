...
Autoscaling fails if your org reaches its vCore limit because there are no available resources to provision new workers. To continue, increase your org’s vCore limit or stop unused apps to free up vCores.
