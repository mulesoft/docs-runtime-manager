...
[NOTE]
To use the autoscaling feature, your organization must have an Enterprise License Agreement (ELA). Entitlement is approved based on qualified use cases. If you are interested in this feature, contact your account representative. Autoscaling for CloudHub is not available for customers using the new usage-based pricing plan.
