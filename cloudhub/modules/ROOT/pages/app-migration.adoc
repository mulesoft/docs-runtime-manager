...
When transitioning to the new runtime, they can either trigger additional requests to the origin servers or have different cached values depending on which runtime receives the requests.
