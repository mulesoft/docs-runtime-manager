...
After traffic fully redirects to the CloudHub 2.0 application, you have 30 days to stop your CloudHub application and mark the upgrade as complete. If you don't stop it within this period, the platform automatically stops the application for you.
...
After you complete the individual application migrations, stop and delete your CloudHub 1.0 applications, and stop and delete any associated CloudHub 1.0 DLBs via DLB failover, the final step for the VPC upgrade is to mark the upgrade as complete.
...
When CloudHub 1.0 resources are replaced by CloudHub 2.0, the CloudHub 1.0 assets become immutable. Make sure that you make all changes on CloudHub 2.0.
