...
[NOTE]
If there are failures during this stage, you can restart the DLB to point `anypointdns.net` to CloudHub while the DLB is in a 'stopped' state. After you delete the DLB, you can't roll back to CloudHub.
