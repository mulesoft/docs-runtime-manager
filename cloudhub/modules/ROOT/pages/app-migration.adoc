...
To link a CloudHub application with a CloudHub 2.0 application and gradually switch traffic using the application migration tool, you must first upgrade the CloudHub VPC to a CloudHub 2.0 private space using the xref:vpc-upgrade.adoc[VPC upgrade tool].
