...
To link a CloudHub application with a CloudHub 2.0 application and gradually switch traffic using the application migration tooling, you must first upgrade the CloudHub VPC to a CloudHub 2.0 private space using the xref:vpc-upgrade.adoc[VPC upgrade tool].

If you move applications into a CloudHub 2.0 private space that hasn't been upgraded from a CloudHub VPC, you can't use the application upgrade tool.
