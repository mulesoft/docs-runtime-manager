...
* Enable the *Accept HTTP* option within the *Advanced* tab of the private space settings for your CloudHub 2.0 application. This allows CloudHub 2.0 to accept HTTP traffic. 
+
...
+
[NOTE]
This workaround can take more work and time depending on how many HTTP CloudHub applications you have.
