...
[WARNING]
====
If you use a different name for the CloudHub 2.0 application, make sure you input the CloudHub application name in the subdomain field of the endpoint configuration within the *Ingress* tab settings. Failing to configure the correct URLs can result in traffic not reaching the CloudHub 2.0 application during xref:app-migration.adoc#next-steps-after-application-upgrade[traffic switching].
