...
* CloudHub live patching process checks the application to ensure it has enough memory and CPU available to live patch. If there is not enough capacity, it skips the patching and retries at a later time. 
--
