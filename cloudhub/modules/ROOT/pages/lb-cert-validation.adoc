...
:page-notice-banner-message: Support for TLS 1.1 and earlier versions in Dedicated Load Balancers (DLB) ends soon. For new DLBs, support for TLS 1.1 and earlier versions ended on <b>December 1, 2025</b>. For existing DLBs, support for TLS 1.1 and earlier versions ends on <b>October 31, 2026</b>. Update your DLB configuration to use TLS 1.2 or a later version to prevent service interruptions.
