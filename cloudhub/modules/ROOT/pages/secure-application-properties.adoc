...
On CloudHub 2.0, configuring masking through `mule-artifact.json` or config-file masking isn't the recommended practice. For information, see xref:cloudhub-2::ch2-protect-app-props.adoc[].
====
...
* xref:cloudhub-2::ch2-protect-app-props.adoc[Protecting App Property Values on CloudHub 2.0]
