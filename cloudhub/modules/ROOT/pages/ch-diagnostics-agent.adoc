...
In Runtime Manager *Diagnostics* page, you run the MuleSoft Diagnostics Agent to generate diagnostics on demand for a chosen replica. You can then download the diagnostics for manual inspection, or *Analyze with Einstein* (or both). 
