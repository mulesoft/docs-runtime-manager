...
On the Runtime Manager *Diagnostics* page, run the MuleSoft Diagnostics Agent to generate diagnostics on demand for a chosen replica. Download the diagnostics for manual inspection, or *Analyze with Einstein* (or both). 
