...
If you expose an API using TLS on CloudHub with the shared load balancer, you can use a self-signed certificate in your Mule application. The shared load balancer replaces that certificate with a publicly trusted certificate. 
