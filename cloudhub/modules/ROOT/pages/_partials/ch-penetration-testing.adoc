...
+
--
** https://help.salesforce.com/s/articleView?id=000383448&type=1[Platform Security FAQ^]
** https://help.salesforce.com/s/[Salesforce Help^]
--
+

. If your assessment generates vulnerability findings, complete validation for any automated finding. Send all outstanding validated security vulnerability findings to the Salesforce Security Team at https://security.salesforce.com/contact[security.salesforce.com/contact].
+
--
...
To report security vulnerability findings, follow the https://help.salesforce.com/s/articleView?id=000384043&type=1[Security Vulnerability Finding Submittal Guide^]. Security vulnerability reports that do not follow the required steps are rejected.
