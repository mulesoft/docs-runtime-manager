...
|===
| Regions in U.S. Control Plane | Region | Target ID | Example DNS Record | Target Name
...
[%header,cols="15a,10a,30a,40a,40a"]
|===
| Regions in EU Control Plane | Region | Target ID | Example DNS Record | Target Name
