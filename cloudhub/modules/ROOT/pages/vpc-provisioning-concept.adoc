...
Associating an environment with a new VPC in the same region as a previously assigned VPC replaces the previous association. However, already-deployed applications continue running on the previous VPC until you restart them.
