...
Use BGP routing to advertise the same routes via VPN-1 and VPN-2. For instructions on how to control path selection via the routing protocol, see https://help.salesforce.com/s/articleView?id=001116889&type=1[Anypoint VPN Path Selection using BGP Routing].
...
* https://help.salesforce.com/s/articleView?id=001114580&type=1[How to Calculate VPC and VPN License Requirements]
