...
[NOTE]
You can view the live status and detailed service history for the Runtime Manager console, platform services, and the CloudHub worker cloud on https://status.salesforce.com/products/Mulesoft[`status.mulesoft.com`] for the default (US hosted) Control Plane and https://status.salesforce.com/products/Mulesoft[`eu1-status.mulesoft.com`] for the EU Control Plane.
...
Workers with 1 or more vCores provide performance consistency.
...
For more information about CloudHub security and compliance, download the https://www.mulesoft.com/api/security[Anypoint Cloud Security & Compliance] whitepaper.
...
For more information about MuleSoft’s approach to security, please see the https://www.mulesoft.com/sites/default/files/security-whitepaper.pdf[Anypoint Cloud Security & Compliance whitepaper].
