...
[NOTE]
The event tracking log file (_$MULE_HOME/logs/events-%d{yyyy-dd-MM}-%i.log_), is not automatically deleted. You need to manually delete the logs periodically.
