...
|CloudHub 1.0 | Each application deployed to CloudHub runs on a separate virtual server. You don't need to use domains to share ports or other resources between applications.|
