...
|CloudHub 2.0
 | - You can create alerts in xref:alerts-on-runtime-manager.adoc[Runtime Manager] for applications deployed to CloudHub 2.0. +
   - You can enable distributed tracing for your CloudHub 2.0 applications that are deployed to either shared or private spaces and running on Mule runtime 4.5.1.e or later.
