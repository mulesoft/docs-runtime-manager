...
|CloudHub 2.0
|image:logo-cloud2-active.png[width=24,height=24,xref="deployment-strategies.adoc#cloudhub-2-deployments", title="CloudHub 2.0"]

|CloudHub
|image:logo-cloud-active.png[width=24,height=24,xref="deployment-strategies.adoc#cloudhub-deployments", title="CloudHub"]
...
|image:logo-rtf-active.png[width=24,height=24,xref="deployment-strategies.adoc#anypoint-runtime-fabric-deployments", title="Runtime Fabric"]
|===
 ...
 | - You can create alerts in xref:alerts-on-runtime-manager.adoc[Runtime Manager] for applications deployed to CloudHub 2.0. +
  ...
  +
   ...
   | - xref:cloudhub-2::ch2-monitor-apps.adoc[Monitoring Apps Deployed to CloudHub 2.0] +
     - xref:cloudhub-2::ch2-deploy-private-space.adoc#enable-trace-data-collection[Enable Trace Data Collection]
...
|Runtime Fabric
 | - The Runtime Fabric agent monitors Kubernetes Deployments labelled with `rtf.mulesoft.com/id`. +
    - You can enable trace data collection for your Runtime Fabric applications running on Mule version 4.6 or later. 
  | When Kubernetes updates the state of the deployment, the agent sends that update to the control plane. |
   ...
   - xref:runtime-fabric::use-anypoint-monitoring.adoc#enable-trace-data[Enable Trace Data Collection]
|===
...
|CloudHub 2.0 | Use the MuleSoft diagnostics agent to troubleshoot your Mule applications deployed to CloudHub 2.0. This feature leverages Einstein generative AI to automate diagnostics collection and provide intelligent, actionable insights. See xref:cloudhub-2::ch2-view-diag.adoc[].
|CloudHub 
| - The xref:insight.adoc[Insight] troubleshooting tool provides in-depth visibility into business transactions and events on your Mule applications deployed through Runtime Manager. You can enable the Insight analytics feature and specify metadata options on the Insight tab. +
  - Use the MuleSoft diagnostics agent to troubleshoot your Mule applications deployed to CloudHub. This feature leverages Einstein generative AI to automate diagnostics collection and provide intelligent, actionable insights. See xref:cloudhub::ch-diagnostics-agent.adoc[].
...
[NOTE]
This feature applies to select customers who opted into the new pricing and packaging model. For more details, visit xref:general::pricing.adoc[Anypoint Platform Pricing].
