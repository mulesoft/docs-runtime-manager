...
|Private Cloud Editon | Server groups or clusters |See the  Mule runtime engine release notes to determine the minimum JDK supported version. | xref:release-notes::mule-runtime/mule-esb.adoc[Mule Runtime Release Notes].
