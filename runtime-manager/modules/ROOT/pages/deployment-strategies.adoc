...
[NOTE]
This feature applies only to select customers who are opted into the new pricing and packaging model. For more details, visit xref:general::pricing.adoc[Anypoint Platform Pricing].
