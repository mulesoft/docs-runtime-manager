...
|Hybrid
|image:logo-hybrid-active.png[width=25,height=25,xref="deployment-strategies.adoc#hybrid-deployments", title="Hybrid"]

|Anypoint Platform Private Cloud Edition
|image:logo-server-active.png[width=25,height=25,xref="deployment-strategies.adoc#anypoint-platform-pce-deployments", title="Anypoint Platform PCE"]
