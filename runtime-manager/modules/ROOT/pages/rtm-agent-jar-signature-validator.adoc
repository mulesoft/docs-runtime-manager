...
You can indicate which single keystore alias you want to use to validate all artifacts deployed in the runtime. Artifacts signed with expired certificates are allowed.
