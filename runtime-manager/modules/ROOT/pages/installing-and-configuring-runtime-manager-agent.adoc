...
[%header,cols="10,30,10"]
|===
|Mule version | Runtime Manager Agent version | Java version
|4.3.0 | 2.4.3 or later | 8
|4.4.0 | 2.4.27 or later | 8
|4.4.0 | 2.4.28 or later | 8,11
|4.5.0 | 2.5.6 or later  | 8,11
|4.6.0 | 2.6.0 or later | 8,11,17
|===
...
For more information on Java compatibility, see xref:general::java-support.adoc[].
...
* When upgrading to versions 2.7.0 and later:
+
See xref:release-notes::runtime-manager-agent/runtime-manager-agent-2.7.x-release-notes.adoc#2-7-0[Upgrade Requirements].
