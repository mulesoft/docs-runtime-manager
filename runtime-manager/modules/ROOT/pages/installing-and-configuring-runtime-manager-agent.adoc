...
[NOTE]
Using a Runtime Manager Agent version earlier than the ones provided in the compatibility map can result in incompatibilities or introduce inconsistencies.
