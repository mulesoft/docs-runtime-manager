...
== Installing or Updating to Runtime Manager Agent Version 2.7.0

Before installing or updating to Runtime Manager Agent Version 2.7.0, update your network configuration to add the following endpoint to your allowlist:

* Port : `8443`
* Protocol: `https`
* Source: `All nodes`
* Destination: 
** US control plane: `us1.ingest.mulesoft.com`
** EU control plane: `eu1.ingest.mulesoft.com`
* Description: `Anypoint Monitoring Ingestion`
