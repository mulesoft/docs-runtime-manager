...
| Maximum number of displayed properties per deployed app | 300
| Maximum deployment size for CloudHub 1.0, Runtime Fabric, and standalone | 200 MB
| Maximum deployment size for CloudHub 2.0 | 350 MB
|===
