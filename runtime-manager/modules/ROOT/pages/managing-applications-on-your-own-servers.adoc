...
image:logo-cloud2-active.png[width=25,height=25,xref="deployment-strategies.adoc#cloudhub-2-deployments", title="CloudHub 2.0"]
image:logo-cloud-active.png[width=25,height=25,xref="deployment-strategies.adoc#cloudhub-deployments", title="CloudHub"]
image:logo-rtf-active.png[width=25,height=25,xref="deployment-strategies.adoc#anypoint-runtime-fabric-deployments", title="Runtime Fabric"]
