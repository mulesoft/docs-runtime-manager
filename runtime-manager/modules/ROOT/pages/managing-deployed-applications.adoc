...
This grace period applies to the application instance, not to the runtime. The runtime uses its own configuration for the gracefully shutdown, which is by default, five seconds.
