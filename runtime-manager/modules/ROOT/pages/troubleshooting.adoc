...
+
Use the MuleSoft diagnostics agent to troubleshoot your Mule applications deployed to xref:ch-diagnostics-agent.adoc[CloudHub] and xref:cloudhub-2::ch2-view-diag.adoc[CloudHub 2.0]. This feature leverages Einstein generative AI to automate diagnostics collection and provide intelligent, actionable insights. 
