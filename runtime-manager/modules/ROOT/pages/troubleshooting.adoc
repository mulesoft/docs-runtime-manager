...
image:logo-cloud2-active.png[width=24,height=24,xref="deployment-strategies.adoc#cloudhub-2-0", title="CloudHub 2.0"]
image:logo-cloud-active.png[width=24,height=24,xref="deployment-strategies.adoc#cloudhub-deployments", title="CloudHub"]
+
Use the MuleSoft diagnostics agent to troubleshoot your Mule applications deployed to xref:cloudhub::ch-diagnostics-agent.adoc[CloudHub] and xref:cloudhub-2::ch2-view-diag.adoc[CloudHub 2.0]. This feature leverages Einstein generative AI to automate diagnostics collection and provide intelligent, actionable insights. 
