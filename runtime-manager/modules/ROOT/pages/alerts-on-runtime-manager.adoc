...
+
--
Memory usage is a percentage that represents the JVM heap-used/JVM total memory. The alert will trigger if the memory usage is above or below the limit for the specified period of time.
