...
+
The Mail Transfer Agent (MTA), a service that transfers emails between a sender's and a recipient's email server, sets alert notification email sending rates.
