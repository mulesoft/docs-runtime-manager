...
image:logo-cloud-active.png[width=25,height=25,link="/runtime-manager/deployment-strategies#cloudhub-deployments", title="CloudHub"]
...
image:logo-hybrid-active.png[width=25,height=25,link="/runtime-manager/deployment-strategies#hybrid-deployments", title="Hybrid"]
