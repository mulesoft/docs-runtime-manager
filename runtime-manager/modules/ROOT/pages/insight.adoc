...
** Tag transactions with custom business events, and then search for transactions based on the custom business events. See xref:mule-runtime::business-events-custom.adoc[Custom Business Event Component].
--
...
Business data, if configured, appears in the Metadata area (*3*) of the dashboard. See xref:mule-runtime::business-events.adoc[Business Event].
...
+
To enable the *Business Data* field your app must have business events configured. See xref:mule-runtime::business-events.adoc[Business Event].
