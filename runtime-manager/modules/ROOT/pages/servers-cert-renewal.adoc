...
. Check *Certificate expiration date* to verify that the certificate renewed successfully, and restart Mule Runtime to start using the new certificates.
