...
[IMPORTANT]
--
Whitelist the following URLs only if you are using Agent versions earlier than 1.12.0 (in Mule 3.x) and 2.2.0 (in Mule 4.x):
* mule-manager.anypoint.mulesoft.com
* arm-auth-proxy.prod.cloudhub.io

Whitelist the following URLs only if you are using Agent versions 1.12.0 (in Mule 3.x) and 2.2.0 (in Mule 4.x) or older:
* runtime-manager.anypoint.mulesoft.com
* data-authenticator.anypoint.mulesoft.com
--
