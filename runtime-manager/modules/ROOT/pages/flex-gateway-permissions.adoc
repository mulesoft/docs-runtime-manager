...
Your Anypoint Platform Admin can also add a Connected App with the appropriate permissions. See xref:access-management::connected-apps-overview [Connected Apps] for more information.
