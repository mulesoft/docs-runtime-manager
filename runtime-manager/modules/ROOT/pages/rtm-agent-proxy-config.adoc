...
+
This is Kerberos flavor-dependent. See the https://web.mit.edu/kerberos/krb5-1.12/doc/admin/conf_files/krb5_conf.html[MIT Kerberos Documentation^] for reference on the MIT implementation, which is the standard in most UNIX and Windows systems.
