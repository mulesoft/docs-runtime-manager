...
* https://help.salesforce.com/s/articleView?id=001116969&type=1[How to troubleshoot communication issues between the Mule Runtime Agent and the OnPrem server].
