...
+
[NOTE]
Despite enabling HTTP Streaming, the uploaded file size cannot be over 200MB.
...
* https://help.mulesoft.com/s/article/How-to-Enable-DLB-Streaming-Feature-via-the-API-in-Cloudhub-1-0[How to Enable DLB Streaming Feature via the API in Cloudhub 1.0^]
