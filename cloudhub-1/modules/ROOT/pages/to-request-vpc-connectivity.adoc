...
. Download the https://github.com/mulesoft/docs-runtime-manager/blob/Discovery-Form-Update-LDS/cloudhub-1/modules/ROOT/assets/attachments/VPC-form-v9.5-template.xlsx[Anypoint VPC discovery form].
+
