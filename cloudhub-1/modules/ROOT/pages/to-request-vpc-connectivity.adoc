...
. Download the xref:assets:attachments::VPC-form-v9.5-template.xlsx[Anypoint VPC discovery form].
+
...
. Download the link:modules/ROOT/assets/attachments/VPC-form-v9.5-template.xlsx[Anypoint VPC discovery form].
+
This form requires Microsoft Excel 2007 or later (with macros enabled).
...
. Download the link:attachments/VPC-form-v9.5-template.xlsx[Anypoint VPC discovery form].
+
This form requires Microsoft Excel 2007 or later (with macros enabled).
