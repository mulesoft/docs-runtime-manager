...
. Download the https://github.com/mulesoft/docs-runtime-manager/raw/d06fed3b3cf38013392a08d2d2672bb4aceeac45/modules/ROOT/assets/attachments/VPC-form-v9.3-template.xlsx[Anypoint VPC discovery form].
+
