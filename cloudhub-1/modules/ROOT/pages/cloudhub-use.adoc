...
Anypoint Runtime Manager allows you to deploy your Mule application to different deployment targets, such as an on-premises server and CloudHub. Using CloudHub 1.0 implies the following:
