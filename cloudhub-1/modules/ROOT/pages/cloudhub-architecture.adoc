...
[cols="10a,45a,45a"]
|===
|image:blue-1.png[1 Integration Applications,width=50%] |<<Integration Applications>> |Applications that you create and deploy to CloudHub to perform integration logic for your business
...
|image:blue-3.png[3 Platform Services,width=50%] |<<Platform Services>> |Shared CloudHub platform services and APIs, which includes CloudHub Insight, alerting, logging, account management, virtual private cloud/secure data gateway, and load balancing
|image:blue-4.png[4 CloudHub 2.0,width=50%] |<<Global Worker Clouds>> |An elastic cloud of _workers_, Mule instances that run integration applications
