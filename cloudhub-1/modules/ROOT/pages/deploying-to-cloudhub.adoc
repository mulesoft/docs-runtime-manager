...
Starting with Mule 4.5, MuleSoft introduces two new release channels, xref:release-notes::_partials/mule-runtime/mule-lts-edge-release-cadence.adoc[Edge and Long-term Support (LTS)].
+
