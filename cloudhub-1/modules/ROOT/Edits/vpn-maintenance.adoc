...
If you are use Azure VPN, ensure that PFS is enabled and adjust the lifetimes for Phase 2. For more information, see:
...
=== Anypoint VPN with BGP Routing Enters into Asymmetric Model after an Update
